 ...
 *
 */
public class EdgeClickListener implements ViewerListener, MouseInputListener {
     ...
     */
    public EdgeClickListener(ViewerPipe vpipe, View vw, Graph g, Entorno entorno, JsonManager parser) {
        this.loop = true;
        this.vpipe = vpipe;
        this.vw = vw;
        this.graph = g;
